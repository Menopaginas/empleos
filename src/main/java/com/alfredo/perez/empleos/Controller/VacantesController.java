...
import com.alfredo.perez.empleos.util.Utileria;
...
public class VacantesController {
	...
	@Autowired
	public IntVacanteService vacantesService;
	
	@Autowired
	public IntCategoriaService categoriasService;
	...
	public String guardarVacante(@Valid Vacante vacante, BindingResult resultado,
			RedirectAttributes atributo, Model model, @RequestParam("archivoImagen") MultipartFile multiPart) {
	 ...
	 * y se vinculade fomra automatica el controlador con la vista
